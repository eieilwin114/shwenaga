...
class AttendanceCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('name');
        CRUD::column('check_in_at');
        CRUD::column('check_in_position');
        CRUD::column('check_out_at');
        CRUD::column('check_out_position');       
    ...
    protected function setupCreateOperation()
    {
        ...
        // CRUD::field('check_in_at');
        // CRUD::field('check_in_position');
        // CRUD::field('check_out_at');
        // CRUD::field('check_out_position');
