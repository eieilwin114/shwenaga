...
Route::view('admin/dashboard','dashboards.overview')->name('home');
...
//     // Route::get('dashboard', 'AdminController@dashboard')->name('backpack.dashboard');
//     // Route::post('login', 'Auth\LoginController@login')->name('backpack.auth.login');
