...
@section('content')  
  {!! Form::model($township,['method' => 'PATCH','route' => ['township.update',$township->id]]) !!}
      ...
      <div class="row">
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group">    
                ...
                {!! Form::select('division_id', $divisions,null, array('placeholder' => 'Choose..','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group">    
                <strong>Township</strong>
                {!! Form::text('township', null, array('placeholder' => 'Township','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 d-flex gap-1 mt-3">
            ...
            <a class="btn btn-secondary text-decoration-none" href="{{ route('township.index') }}">
