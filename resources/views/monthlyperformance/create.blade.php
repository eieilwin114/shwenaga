...
@section('content')
  ...
  {!! Form::open(['method' => 'POST','route' => ['monthlyperformance.store']]) !!}
      <div class="row justify-content-center">
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">    
                <strong>လ ၊ ခုနှစ်</strong>
                {!! Form::month('month', null, array('placeholder' => $from_date,'class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
                <strong>ဆိုင်အမည်</strong>
                {!! Form::select('shop_id', $shops, null,array('placeholder' => 'Choose..','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
                <strong>ဝန်ထမ်းအမည်</strong>
                {!! Form::select('employee_id', $employees, null,array('placeholder' => 'Choose..','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-md-10 col-lg-10">
          <table class="table table-bordered my-5">
            ...
            <tr>
                ...
                <td>{!! Form::number('mark1', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'mark1','min'=>0,'max'=>20,'required')) !!}</td>
            </tr>
            <tr>
                <td>၂</td>
                ...
                <td>{!! Form::number('mark2', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'mark2','min'=>0,'max'=>20,'required')) !!}</td>
            </tr>
            <tr>
                <td>၃</td>
                ...
                <td>{!! Form::number('mark3', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'mark3','min'=>0,'max'=>20,'required')) !!}</td>
            </tr>
            <tr>
                <td>၄</td>
                ...
                <td>{!! Form::number('mark4', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'mark4','min'=>0,'max'=>20,'required')) !!}</td>
            </tr>
            <tr>
                <td>၅</td>
                ...
                <td>{!! Form::number('mark5', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'mark5','min'=>0,'max'=>20,'required')) !!}</td>
            </tr>
            <tr>
                <td></td>
                <td class="text-right"><b>စုစုပေါင်းရမှတ်</b></td>
                <td>{!! Form::number('total_mark', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'total_mark','required')) !!}</td>
            </tr>
            <tr>
                <td></td>
                <td class="text-right"><b>၁ မှတ်လျှင် ၂၀၀ ကျပ်နှုန်းဖြင့် မြှောက်၍ ရရှိသော စုစုပေါင်း ငွေပမာဏ</b></td>
                <td>{!! Form::number('total', 0,array('placeholder' => '','class' => 'form-control text-right','id'=>'total','required')) !!}</td>
            </tr>
        </table>
