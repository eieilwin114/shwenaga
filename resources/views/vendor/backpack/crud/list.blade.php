...
@section('content')
  ...
  <div class="row">
    ...
    <div class="{{ $crud->getListContentClass() }}">
        ...
        <div class="d-md-flex mb-2 mb-3">
          <div class="flex-grow-1">
            @if ( ( !Route::is('order-item.index') && !Route::is('attendance.index') ) && $crud->buttons()->where('stack', 'top')->count() ||  $crud->exportButtons())
        ...
        <div class="{{ backpack_theme_config('classes.tableWrapper') }} card card-table">
            <table
              id="crudTable"
            ...
            <thead>
              <tr>
                ...
                @if ( ( !Route::is('order-item.index') && !Route::is('attendance.index') ) && $crud->buttons()->where('stack', 'line')->count() )
        ...
        @if ( !Route::is('order-item.index') && $crud->buttons()->where('stack', 'bottom')->count() )
