            ...
            <form class="form" action="{{ route('backpack.account.info.store') }}" method="post">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-orange"><i class="ti ti-save"></i> {{ trans('backpack::base.save') }}</button>
        ...
        <div class="col-lg-8 mb-4">
            <form class="form" action="{{ route('backpack.account.password') }}" method="post">
                ...
                <div class="card padding-10">
                    ...
                    <div class="card-footer">
                            <button type="submit" class="btn btn-orange"><i class="ti ti-save"></i> {{ trans('backpack::base.change_password') }}</button>
                            <a href="{{ backpack_url() }}" class="btn">{{ trans('backpack::base.cancel') }}</a>
                    </div>
